...
from config import LIGHT_ADDRESS, LIGHT_MAC, LIGHT_MESH_ADDRESS
...
def selftest():
    ...
    dummy_session.mesh_address = 0x0043
    ...
    assert dummy_session._encrypt_command(command=0xF0, payload=unhexlify("440a0000000000000000")) == unhexlify("9a4af31e31ca29db8f123a5f2fe0f6075dd2d9a8")
...
async def main():
    ...
    print("Set off...")
    await light.set_onoff(on=False)
    print("Set off!")
    await sleep(10)
    print("Set on...")
    await light.set_onoff(on=True)
    print("Set on!")
    await sleep(10)
